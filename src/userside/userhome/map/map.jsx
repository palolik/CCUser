          ...
          >
            {isHovered && (
              <div
                ...
                style={{ background:"rgba(9,21,40,0.95)", minWidth:'100px' }}
              >
                <span className="text-xs text-blue-200/80 font-light leading-snug">{icon.data}</span>
                <span
            ...
            <div
              ...
              style={{ transform: isHovered ? 'scale(1.25)' : 'scale(1)', transition:'all 0.2s ease' }}
            >
              <div
                style={{
                  ...
                  boxShadow: isHovered ? '0 0 12px rgba(96,165,250,0.9)' : '0 0 6px rgba(59,130,246,0.6)',
                  display:'flex', alignItems:'center', justifyContent:'center',
                  transition:'all 0.2s ease',
                }}
              >
                <img src="/assets/iconsvg.svg" alt="pin"
                  style={{ width:'65%', height:'65%', objectFit:'contain', transform:'rotate(45deg)' }} />
              </div>
              <div
                style={{
                  width:'2px',
